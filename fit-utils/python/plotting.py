...
def SetPaletteDiverging():
    R.TColor.CreateGradientColorTable(4,
        array ("d", [0.000, 0.500, 0.550, 1.00]),
        array ("d", [0.129, 1.000, 1.000, 0.698]),
        array ("d", [0.400, 1.000, 1.000, 0.094]),
        array ("d", [0.675, 1.000, 1.000, 0.169]),
        255,  1.0)

def SetPaletteGradient():
    R.TColor.CreateGradientColorTable(4,
        array("d", [0.000, 0.059, 0.706, 1.000]),
        array("d", [1.000, 0.988, 0.698, 0.263]),
        array("d", [1.000, 0.914, 0.094, 0.035]),
        array("d", [1.000, 0.922, 0.169, 0.063]),
        255,  1.0)
